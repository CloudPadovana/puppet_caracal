class controller_caracal::pwl_access inherits controller_caracal::params {
...
"
  ...
  File["nova_sshdir"] -> file {
	...
	"private_key":
	    source  => "puppet:///modules/controller_caracal/$controller_caracal::params::private_key",
	...
	"public_key":
            ...
            content => "$controller_caracal::params::pub_key",
            owner   => nova,
            group   => nova;
