...
# inherits compute_caracal::params {
...
#          #require     => Class['compute_caracal::libvirt'],
#         }
...
#   create_resources(sysctl::value,$my_sysctl_settings)
   ...
   file {'INFN-CA.pem':
             source      => 'puppet:///modules/compute_caracal/INFN-CA.pem',
             path        => '/etc/grid-security/certificates/INFN-CA.pem',
        }

   file {'CloudVenetoCAs.pem':
             source      => 'puppet:///modules/compute_caracal/CloudVenetoCAs.pem',
